...
import {
    ...
    ScrollView,
    Image,
    TouchableOpacity, Alert, NativeModules, DeviceEventEmitter, BackHandler, Platform,
} from 'react-native';
import AppConfig from "../common/AppConfig";
import LoadingView from "../common/LoadingView";

export default class SendRedPackLucky extends Component{
        ...
        return (
            <ScrollView style={styles.wrapper}>
                <View style={styles.textLabelTop}>
                    <Text style={{fontSize:12,color:'#A5A5A5'}}>拼手气红包，每人抢到的红包金额随机</Text>
                </View>
                ...
                <View style={styles.textInput1}>
                    <Text style={styles.text}>总金额</Text>
                    <TextInput
                        style={{flex:1,height:40}}
